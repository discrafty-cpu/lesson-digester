/**
 * ProblemGenerator v2.0 — Client-side parametric math problem generation
 *
 ...
 *
 * Each returned problem now includes benchmark metadata when available:
 *   { stem, answer, hint, dok, benchmarkCodes?, clusterKey?, clusterLabel? }
 *
...
const ProblemGenerator = (() => {
  ...
  const resolveTopicData = (topic, gradeHint) => {
    ...
    // Try grades 6, 7, 8 (or use hint) to find the topic
    const gradesToTry = gradeHint ? [gradeHint] : [6, 7, 8, 5, 4, 3];
